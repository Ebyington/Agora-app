        ...
        <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="flex-row space-between my-2">
                ...
                <div className="flex-row flex-end">
                    ...
                    <button className="inline-block px-7 py-3 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out w-full" type="text-white font-bold py-2 px-4 rounded-full">Submit</button>
                </div>
            </form>
        </div>
    );
